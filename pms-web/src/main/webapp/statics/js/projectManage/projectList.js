...
var vm = new Vue({
    ...
    methods : {
        ...
        showDetails:function(project){//跳转到项目详情页面
            ...
            parent.window.location.href = '../projectManage/projectDetails.html?projId='+project.projId;
        },
        archProjQuery: function(){//跳转到归档项目查询页面
            toUrl('../projectManage/archivedProject.html');
        },
        editProjTemp: function(){//编辑项目模板页面
            toUrl('../projectManage/projectTemplate.html');
        }
    },
    computed: {
    }
